    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
        ...
        <div class="w3-row-padding w3-padding-16 w3-center" id="drink">
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Black_velvet.jpg" alt="Black Velvet" class="images">
                </div>
                <h3>Black Velvet</h3>
            ...
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Bloody_mary.jpg" alt="Bloody Mary" class="images">
                </div>
                <h3>Bloody Mary</h3>
            ...
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Bora_bora.jpg" alt="Bora Bora" class="images">
                </div>
                <h3>Bora Bora</h3>
            ...
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Builder.jpg" alt="Builder" class="images">
                </div>
                <h3>Builder</h3>
                <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
            </div>
        ...
        <div class="w3-row-padding w3-padding-16 w3-center">
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Caipirinha.jpg" alt="Caipirinha" class="images">
                </div>
                <h3>Caipirinha</h3>
                <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
            </div>
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Coconut_kiss.jpg" alt="Coconut Kiss" class="images">
                </div>
                <h3>Coconut Kiss</h3>
                <p>Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.
                </p>
            ...
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Cuba_libre.jpg" alt="Cuba Libre" class="images">
                </div>
                <h3>Cuba Libre</h3>
                <p>Just some random text, lorem ipsum text praesent tincidunt ipsum lipsum.</p>
            </div>
            <div class="w3-quarter">
                <div class="img">
                    <img src="Photos/Frosty_lime.jpg" alt="Frosty Lime" class="images">
                </div>
                <h3>Frosty Lime</h3>
